...
{% include list.html  data="members"  component="portrait"  filters="role: current-msphd-2025-1" %}
{% include list.html  data="members"  component="portrait"  filters="role: current-msphd-2025-2" %}
{% include list.html  data="members"  component="portrait"  filters="role: current-msphd-2026-1" %}
{% include list.html  data="members"  component="portrait"  filters="role: current-ms-2026-1" %}
